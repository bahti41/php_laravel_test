                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form method="post" action="{{ route('banner.guncelle') }}" enctype="multipart/form-data">
                            ...
                            <input type="hidden" name="onceki_resim" value="{{$seo->resim}}">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control" name="keywords" type="url" placeholder="Anahtar Giriniz..." id="example-text-input" value="{{$seo->keywords}}">
                                </div>
                            </div>
                            <!-- Anahtar -->
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control" name="author" type="url" placeholder="Yapımcı / Author Giriniz..." id="example-text-input" value="{{$seo->author}}">
                                </div>
                            </div>
                            <!-- Yapımcı / Author -->
